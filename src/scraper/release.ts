...
import type { HentaiRelease, IError } from "../types/interfaces.js";
 ...
 * @returns {Promise<HentaiRelease[] | IError>} Array object of released hentai.
 */
export const release = async (
  page: number = 1
): Promise<HentaiRelease[] | IError> => {
